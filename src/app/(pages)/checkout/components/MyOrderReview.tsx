...
const MyOrderReview = () => {
  ...
  const subTotal: number = checkoutList.reduce(
        ...
        <div className="flex flex-col gap-2 px-6 py-4">
          ...
          <div className="flex justify-between items-center">
            ...
            <p className="font-bold text-2xl max-lg:text-xl">
              $ {(subTotal - discount + tip + tax).toFixed(2)}
            </p>
          </div>
        </div>

        <div className="px-6 py-8">
          <button className="bg-[#F8991D] text-white font-bold text-2xl w-full rounded-full py-4">
            Place order
          </button>
        </div>
      </div>
